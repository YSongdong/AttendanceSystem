...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        upVeiw.backgroundColor = [UIColor colorWithHexString:@"#f7f7f7"];
        ...
        [cancelButton setTitleColor:[UIColor colorWithHexString:@"#aaaaaa"] forState:UIControlStateNormal];
        [cancelButton addTarget:self action:@selector(cancelButtonClick) forControlEvents:UIControlEventTouchUpInside];
        [upVeiw addSubview:cancelButton];
        
        //显示timelab
        timeLab = [[UILabel alloc]init];
        [upVeiw addSubview:timeLab];
        timeLab.text = @"日期选择";
        timeLab.font = Font(18);
        timeLab.textColor = [UIColor colorCommonGreenColor];
        ...
        [chooseButton setTitleColor:[UIColor colorWithHexString:@"#aaaaaa"] forState:UIControlStateNormal];
        ...
        splitView.backgroundColor = [UIColor colorWithHexString:@"#cccccc"];
